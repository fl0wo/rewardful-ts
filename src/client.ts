...
const endpoints = makeApi([
  ...
  },
  {
    ...
    response: z.object({
      ...
      url: z
        .string()
        .url()
        .describe("The URL associated with the affiliate link."),
      token: z
        .string()
        .describe(
          "The unique token for the affiliate link, usually a short identifier."
      ...
      conversions: z
        ...
        .int()
        .describe(
          "The number of conversions generated by this affiliate link."
        ),
      affiliate_id: z
        .string()
        .uuid()
        ...
        schema: z
          .object({
            ...
            email: z
              .string()
              .email()
              .describe("Email address of the affiliate"),
            token: z
              .string()
              .describe("Unique identifier or token for the affiliate"),
            stripe_customer_id: z
  ...
  },
  {
    ...
    response: z.object({ sso: SSO, affiliate: AffiliateBasic }).partial(),
    errors: [
      {
        status: 401,
        description: `Unauthorized - Invalid API key or permissions`,
    ...
    parameters: [
      {
        ...
        schema: z.object({
          ...
          url: z
            .string()
            .url()
            .describe("The URL associated with the campaign."),
          private: z
            .boolean()
            .describe("Indicates if the campaign is private."),
          reward_type: z
            .enum(["percent", "flat"])
            .describe(
              "Type of reward for the campaign, either 'percent' or 'flat'."
            ),
          commission_percent: z
            .number()
            .describe("Commission percentage if the reward type is 'percent'.")
    ...
    response: z
      .object({
        id: z
          .string()
          .uuid()
          .describe("The unique identifier of the campaign."),
        created_at: z
          .string()
          .datetime({ offset: true })
          .describe("Timestamp when the campaign was created."),
        ...
        affiliate_dashboard_text: z
          .string()
          .describe(
            "Text displayed on the affiliate dashboard for this campaign."
          ),
        custom_reward_description: z
          .string()
          .describe(
        ...
        sale_description_visible_to_affiliates: z
          .boolean()
          .describe(
            "Indicates if the sale description is visible to affiliates."
          ),
        parameter_type: z
          .enum(["query", "hash", "path"])
          .describe("Parameter type used by the campaign."),
        ...
        default: z
          .boolean()
          .describe("Indicates if this is the default campaign."),
        reward_type: z
          .enum(["percent", "flat"])
          .describe(
            "Type of reward for the campaign, either a percentage or a flat amount."
  ...
  },
  {
    ...
    response: z.object({
      id: z
        .string()
        .uuid()
        .describe("The unique identifier for the commission."),
      created_at: z
        .string()
        .datetime({ offset: true })
        .describe("Timestamp when the commission was created."),
      ...
      amount: z
        .number()
        .int()
        .describe("The amount of the commission in cents."),
      currency: z.string().describe("The currency of the commission amount."),
      due_at: z
        .string()
        .datetime({ offset: true })
